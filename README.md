# School-Efficiency-Dashboard
This dashboard represents a comprehensive School Performance and Efficiency Analysis, likely designed for educational administrators or government stakeholders to monitor academic outcomes and operational health.

<h1>📌Project Overview </h1>
This project provides a data-driven overview of educational institutions' performance, focusing on student outcomes, teacher reliability, and parental feedback. The dashboard enables stakeholders to identify high-performing grade levels, assess resource allocation (funding vs. performance), and pinpoint subjects requiring curriculum or teaching interventions.

<h2> 📊 Key Performance Indicators (KPIs)</h2>
The dashboard tracks five primary metrics to gauge institutional health:

- Student to Teacher Ratio (3.2): An exceptionally low ratio, suggesting highly personalized instruction or potential overstaffing.

- Teachers' Attendance Rate (94.8%): High reliability in staff presence, which correlates strongly with student stability.

- Graduation Rate (31.9%): A critical area for concern; despite high attendance and low ratios, less than a third of students are graduating.

- Average Revenue Per Student (59,068): Represents the financial investment or cost-efficiency per pupil.
...
- Data Source: Educational Management Information System (EMIS).

- Design Theme: High-contrast Dark Mode for executive presentations.
...
<h2> 📌 Overview </h2>
Page 2 shifts the focus from academic results to the environment in which learning occurs. It evaluates how class sizes, teacher experience, and extracurricular activities impact the "Sustainability KPI" of the institution. 

<h2> 🔑 Key Performance Indicators (KPIs)</h2> 
- Teachers' Experience Impact (No Correlation): A statistical finding indicating that, within this dataset, higher years of teacher experience do not directly correlate with improved student outcomes.

- Average Class Size (55.5): The mean number of students per classroom across all subjects.

- % Average Performing Student (12.1%): The percentage of students meeting the "High Performing" benchmark.

- Sustainability KPI (53): A composite score measuring the long-term viability of school operations.

- % Passing Rate (92%): The overall success rate for the current reporting period.
...
- Addressing the "Experience Gap": Since teacher experience shows "No Correlation" with impact, the administration should review teaching methodologies or professional development programs rather than relying solely on seniority.

- Performance Stagnation: The low percentage of "Average Performing Students" (12.1%) suggests that while 92% of students are "passing," very few are reaching high-performance benchmarks. A "Gifted and Talented" program could help move students from passing to excelling.

- Subject Focus: Address the downward trend in parental satisfaction for Mathematics and Government through targeted workshops or curriculum reviews.
...
🔗 [View Power BI Dashboard](https://app.powerbi.com/view?r=eyJrIjoiNWYzMDM0MjctNzJmYi00YjU0LWE0MmEtN2U1MGNhYTg2ZGJkIiwidCI6IjU4MTgxNmIyLWMwYmUtNGVhYS04MGUzLTI5ZTVmMjQ4NjQ5NCIsImMiOjh9)
